(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    2823: function (e, t, r) {
      Promise.resolve().then(r.bind(r, 4782));
    },
    2323: function (e, t, r) {
      "use strict";
      r.d(t, {
      ...
      let u = () => {
        ...
        c = (e) => {
          let { children: t } = e,
            ...
            [v, g] = (0, a.useState)(null),
            [b, w] = (0, a.useState)(null),
            [m, x] = (0, a.useState)(null),
            [k, C] = (0, a.useState)(null),
            [y, j] = (0, a.useState)(!1),
            [S, E] = (0, a.useState)(""),
            [I, U] = (0, a.useState)(null),
            [_, N] = (0, a.useState)(null);
          return (
            (0, a.useEffect)(() => {
              let e = u();
              e && (U(e), E(e.role));
        ...
        return (
          ...
          (0, n.jsx)("html", {
            ...
            children: (0, n.jsxs)("body", {
              ...
              children: [
                (0, n.jsx)("div", {
                  children: (0, n.jsx)(s.Ix, { position: "top-right" }),
                }),
                (0, n.jsx)("div", {
                  className: "dark:bg-boxdark-2 dark:text-bodydark",
                  children: (0, n.jsx)(o._, {
                    children: l ? (0, n.jsx)(i, {}) : t,
                  }),
                }),
              ],
            }),
    ...
    3297: function (e, t, r) {
      ...
      function a(e, t) {
        ...
        let a = !0 === t.header ? 0 : 1,
          i = e.split(".")[a];
        if ("string" != typeof i)
          throw new n(`Invalid token specified: missing part #${a + 1}`);
        try {
          r = (function (e) {
          ...
          throw new n(
            `Invalid token specified: invalid base64 for part #${a + 1} (${e.message})`,
          );
        }
        try {
          return JSON.parse(r);
          ...
          throw new n(
            `Invalid token specified: invalid json for part #${a + 1} (${e.message})`,
          );
        }
      }
  ...
  function (e) {
    e.O(0, [227, 250, 948, 42, 516, 744], function () {
      return e((e.s = 2823));
    }),
      (_N_E = e.O());
  },
