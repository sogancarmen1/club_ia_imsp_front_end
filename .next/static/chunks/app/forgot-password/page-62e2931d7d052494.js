(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    9062: function (C, e, l) {
      Promise.resolve().then(l.bind(l, 2701));
    },
    2701: function (C, e, l) {
      "use strict";
      l.r(e);
      ...
      e.default = () => {
        ...
        let [e, l] = (0, a.useState)(""),
          ...
          x = async (l) => {
            l.preventDefault();
            try {
              let l = await d.Z.post(
                "https://club-ia-imsp-backend.onrender.com/forgot-password",
                { email: e },
              );
              l.data.sucess &&
                (o.Am.success(l.data.message), C.push("/reset-password"));
            } catch (C) {
              console.log(C), o.Am.error(C.response.data.message);
            }
          };
        return (0, s.jsx)("div", {
                        ...
                        children: [
                          ...
                          (0, s.jsx)("div", {
                            ...
                            children: (0, s.jsx)("input", {
                              type: "submit",
                              value: "Recevoir le lien de r\xe9initialisation",
                              className:
