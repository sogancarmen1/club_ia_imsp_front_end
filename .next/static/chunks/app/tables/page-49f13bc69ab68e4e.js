(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    3460: function (e, t, r) {
      Promise.resolve().then(r.t.bind(r, 7225, 23)),
        Promise.resolve().then(r.t.bind(r, 125, 23)),
        Promise.resolve().then(r.bind(r, 5900)),
        Promise.resolve().then(r.bind(r, 5658));
    },
    5658: function (e, t, r) {
      "use strict";
      var s = r(7752),
      ...
      t.default = () => {
        ...
        if ((l.Z.get("Authorization"), t && "admin" !== t))
          return (0, s.jsx)("p", {});
        let r = async (e) => {
          try {
            await d.Z.delete(
