(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    3154: function (e, t, r) {
      Promise.resolve().then(r.bind(r, 6003));
    },
    3324: function (e, t, r) {
      "use strict";
      r.d(t, {
      ...
      var i = function () {
        ...
        d = function (e) {
          var t = e.loading,
            ...
            x = i({ display: "inherit" }, void 0 === C ? {} : C),
            v = function (e) {
              return {
    ...
    6003: function (e, t, r) {
      ...
      t.default = () => {
        let [e, t] = (0, n.useState)(""),
          ...
          [v, g] = (0, n.useState)(""),
          b = (0, s.useRouter)(),
          { setToken: w, setRole: j, setValueDecoded: k } = (0, d.Q)(),
          y = async (t) => {
            let a;
            t.preventDefault();
            try {
              if (
                ...
                b.push("/admin");
                let e = (0, c.o)(a.data.data.match(/Authorization=([^;]+)/)[1]);
                k(e),
                  w(a.data.data.match(/Authorization=([^;]+)/)[1]),
                  j(e._role),
                  C.Am.success(a.data.message);
              }
            } catch (e) {
              C.Am.error(e.response.data.message), f(!1), x(!0);
            }
          };
        return (0, a.jsx)("div", {
    ...
    3297: function (e, t, r) {
      ...
      function n(e, t) {
        ...
        t || (t = {});
        let n = !0 === t.header ? 0 : 1,
          l = e.split(".")[n];
        if ("string" != typeof l)
          throw new a(`Invalid token specified: missing part #${n + 1}`);
        try {
          r = (function (e) {
  ...
  function (e) {
    e.O(0, [250, 570, 948, 42, 516, 744], function () {
      return e((e.s = 3154));
    }),
      (_N_E = e.O());
  },
