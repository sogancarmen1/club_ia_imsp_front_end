(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    9769: function (e, r, t) {
      Promise.resolve().then(t.bind(t, 5945));
    },
    3324: function (e, r, t) {
      "use strict";
      t.d(r, {
      ...
      var s = function () {
        ...
        o = (function (e, r, t) {
          var a = "react-spinners-".concat(e, "-").concat(t);
        ...
        d = function (e) {
          var r = e.loading,
            ...
            h = s({ display: "inherit" }, void 0 === u ? {} : u),
            v = function (e) {
              return {
      ...
      var a = t(7752),
          ...
          let [e, r] = (0, i.useState)(""),
            ...
            j = async (r) => {
              ...
              try {
                ...
                e.data.sucess && (h(!1), k(!0)), n.Am.success(e.data.message);
              } catch (e) {
                h(!1), k(!0), n.Am.error(e.response.data.message);
              }
            };
          return (0, a.jsxs)(a.Fragment, {
            children: [
              (0, a.jsx)(l.Z, { pageName: "Ajouter un article ou un projet" }),
              (0, a.jsx)("form", {
                onSubmit: j,
                                  ...
                                  children: (0, a.jsxs)("div", {
                                    children: [
                                      ...
                                      (0, a.jsx)("textarea", {
                                        ...
                                        rows: 6,
                                        placeholder:
                                          "Entrez le contenu ou description de l'article/projet",
                                        required: !0,
                                        className:
                                          "w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary",
                                      }),
                              ...
                              (0, a.jsxs)("div", {
                                children: [
                                  (0, a.jsx)("label", {
                                    className:
                                      "mb-3 block text-sm font-medium text-black dark:text-white",
                                    children: "Selectionner Article ou Projet",
                                  }),
                                  (0, a.jsxs)("div", {
                                    className:
                                      "relative z-20 bg-white dark:bg-form-input",
                                    children: [
                                      (0, a.jsx)("span", {
                                        className:
                                      ...
                                      (0, a.jsxs)("select", {
                                        ...
                                        required: !0,
                                        className:
                                          "relative z-20 w-full appearance-none rounded border border-stroke bg-transparent px-12 py-3 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input ".concat(
                                            p
                              ...
                              (0, a.jsxs)("div", {
                                children: [
                                  (0, a.jsx)("label", {
                                    className:
                                      "mb-3 block text-sm font-medium text-black dark:text-white",
                                    children: "Ajouter un ou plusieus fichiers",
                                  }),
                                  (0, a.jsx)("input", {
                                    type: "file",
                                    onChange: (e) => {
        ...
        m = () => {
          ...
          return (
            ...
            (0, a.jsx)(c.default, { children: (0, a.jsx)(d, {}) })
          );
        };
    },
    7204: function (e, r, t) {
