(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    6501: function (C, e, s) {
      Promise.resolve().then(s.bind(s, 6454));
    },
    6454: function (C, e, s) {
      "use strict";
      s.r(e);
      ...
      e.default = () => {
        let C = (0, i.useRouter)(),
          e = (0, i.useSearchParams)().get("token"),
          [s, h] = (0, a.useState)(""),
          [n, c] = (0, a.useState)(""),
          [x, p] = (0, a.useState)("");
        (0, a.useEffect)(() => {
          e || C.push("/auth/signin");
        }, [e]);
        let m = async (l) => {
          if ((l.preventDefault(), s !== n)) {
            o.Am.success("Passwords don't match!");
            return;
          }
          try {
            let l = await d.Z.put(
            ...
            l.data.sucess &&
              (o.Am.success(l.data.message), C.push("/auth/signin"));
          } catch (C) {
            o.Am.error(C.response.data.message);
          }
        };
        return (0, l.jsx)("div", {
  ...
  function (C) {
    C.O(0, [250, 570, 948, 42, 516, 744], function () {
      return C((C.s = 6501));
    }),
      (_N_E = C.O());
  },
