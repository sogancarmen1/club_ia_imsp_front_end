(() => {
    ...
    (e.modules = {
      ...
      5394: (e, r, t) => {
        ...
        let c = [
                  ...
                  children: [
                    "form-editor",
                    {
                      children: [
                        ...
                        {
                          page: [
                            () => Promise.resolve().then(t.bind(t, 7264)),
                            "/root/club_ia_imsp_frontend/src/app/forms/form-editor/page.tsx",
                          ],
                        },
                      ],
                    },
          ...
          u = "/forms/form-editor/page",
          p = { require: t, loadChunk: () => Promise.resolve() },
          m = new s.AppPageRouteModule({
            definition: {
              kind: a.x.APP_PAGE,
              page: "/forms/form-editor/page",
              pathname: "/forms/form-editor",
              bundlePath: "",
              filename: "",
              appPaths: [],
            },
      ...
      2699: (e, r, t) => {
        Promise.resolve().then(t.bind(t, 630));
      },
      8378: (e, r, t) => {
        "use strict";
        t.d(r, { Z: () => c });
        ...
        function i(e) {
          var r = (function (e) {
            ...
            r = t.includes(".") ? parseFloat(t) : parseInt(t, 10);
            var s = (e.match(/[^0-9]*$/) || "").toString();
            return a[s]
              ? { value: r, unit: s }
              : (console.warn(
                  "React Spinners: "
        ...
        var o = function () {
          ...
          l = (function (e, r, t) {
            var s = "react-spinners-".concat(e, "-").concat(t);
        ...
        let c = function (e) {
          var r = e.loading,
            ...
            b = o({ display: "inherit" }, void 0 === u ? {} : u),
            v = function (e) {
              return {
          ...
          return void 0 === r || r
            ? s.createElement(
                "span",
                o({ style: b }, h),
                s.createElement("span", { style: v(1) }),
                s.createElement("span", { style: v(2) }),
                s.createElement("span", { style: v(3) }),
              )
            : null;
        };
      },
      630: (e, r, t) => {
        ...
        let d = () => {
          ...
          let x = async (t) => {
            ...
            try {
              ...
              r(""),
                t.data.sucess && (i(!1), u(!0)),
                l.Am.success(t.data.message);
            } catch (e) {
              i(!1), u(!0), l.Am.error(e.response.data.message);
            }
          };
          return (0, s.jsxs)(s.Fragment, {
            children: [
              s.jsx(o.Z, { pageName: "Ajouter un \xe9diteur" }),
              s.jsx("form", {
                onSubmit: x,
                children: s.jsx("div", {
                  className: "",
        ...
        let m = () => {
          ...
          return (
            ...
            s.jsx(i.default, { children: s.jsx(d, {}) })
          );
        };
      },
      6363: (e, r, t) => {
      ...
      7264: (e, r, t) => {
        ...
        let s = (0, t(497).createProxy)(
          String.raw`/root/club_ia_imsp_frontend/src/app/forms/form-editor/page.tsx#default`,
        );
      },
    });
  ...
  r.C(e);
  var t = (e) => r((r.s = e)),
    s = r.X(0, [639, 610, 366, 700, 522], () => t(5394));
  module.exports = s;
})();
