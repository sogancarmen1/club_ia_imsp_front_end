(() => {
    ...
    (e.modules = {
      ...
      2132: (e, t, r) => {
        ...
        let d = [
                  ...
                  children: [
                    "signin",
                    {
                      children: [
                        ...
                        {
                          page: [
                            () => Promise.resolve().then(r.bind(r, 8142)),
                            "/root/club_ia_imsp_frontend/src/app/auth/signin/page.tsx",
                          ],
                        },
                      ],
                    },
          ...
          c = ["/root/club_ia_imsp_frontend/src/app/auth/signin/page.tsx"],
          C = "/auth/signin/page",
      ...
      4531: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 9200));
      },
      2165: (e, t, r) => {
      ...
      8378: (e, t, r) => {
        ...
        let d = function (e) {
          var t = e.loading,
            ...
            f = l({ display: "inherit" }, void 0 === C ? {} : C),
            g = function (e) {
              return {
          ...
          return void 0 === t || t
            ? a.createElement(
                "span",
                l({ style: f }, m),
                a.createElement("span", { style: g(1) }),
                a.createElement("span", { style: g(2) }),
                a.createElement("span", { style: g(3) }),
              )
            : null;
        };
      },
      9200: (e, t, r) => {
        ...
        let p = () => {
          let [e, t] = (0, s.useState)(""),
            ...
            [g, b] = (0, s.useState)(""),
            v = (0, n.useRouter)(),
            { setToken: j, setRole: w, setValueDecoded: y } = (0, d.Q)(),
            k = async (t) => {
              let a;
              t.preventDefault();
              try {
                if (
                  ...
                  v.push("/admin");
                  let e = (0, c.o)(
                    a.data.data.match(/Authorization=([^;]+)/)[1],
                  );
                  y(e),
                    j(a.data.data.match(/Authorization=([^;]+)/)[1]),
                    w(e._role),
                    C.Am.success(a.data.message);
                }
              } catch (e) {
                C.Am.error(e.response.data.message), x(!1), f(!0);
              }
            };
          return a.jsx("div", {
              ...
              (0, s.useEffect)(() => {
                (async () => {
                  try {
                    ...
                    b(t.data.data), C(t.data.data.length);
                    let a = await i.Z.get(
                      "http://localhost:4000/articles/article",
                      { withCredentials: !0 },
                    );
                    f(a.data.data), p(a.data.data.length);
                    let s = await i.Z.get(
                      "http://localhost:4000/articles/medias",
                      { withCredentials: !0 },
                    );
                    if ((x(s.data.data), "admin" == k)) {
                      let e = await i.Z.get(
        ...
        function o({ children: e }) {
          ...
          return a.jsx("html", {
            ...
            children: (0, a.jsxs)("body", {
              ...
              children: [
                a.jsx("div", {
                  children: a.jsx(n.Ix, { position: "top-right" }),
                }),
                a.jsx("div", {
                  className: "dark:bg-boxdark-2 dark:text-bodydark",
                  children: a.jsx(l._, { children: o ? a.jsx(i, {}) : e }),
                }),
              ],
            }),
          });
      ...
      8142: (e, t, r) => {
        ...
        let a = (0, r(497).createProxy)(
          String.raw`/root/club_ia_imsp_frontend/src/app/auth/signin/page.tsx#default`,
        );
      },
      9863: (e, t, r) => {
        "use strict";
  ...
  t.C(e);
  var r = (e) => t((t.s = e)),
    a = t.X(0, [639, 610, 366, 700], () => r(2132));
  module.exports = a;
})();
