(() => {
    ...
    (e.modules = {
      ...
      6495: (e, t, s) => {
        ...
        let C = [
              ...
              children: [
                "forgot-password",
                {
                  children: [
                    ...
                    {
                      page: [
                        () => Promise.resolve().then(s.bind(s, 6908)),
                        "/root/club_ia_imsp_frontend/src/app/forgot-password/page.tsx",
                      ],
                    },
                  ],
                },
                {
                  metadata: {
                    icon: [
                      async (e) =>
                        (await Promise.resolve().then(s.bind(s, 807))).default(
                          e,
                        ),
                    ],
                    apple: [],
            ...
            {
              layout: [
                () => Promise.resolve().then(s.bind(s, 9863)),
                "/root/club_ia_imsp_frontend/src/app/layout.tsx",
              ],
              "not-found": [
                () => Promise.resolve().then(s.t.bind(s, 3035, 23)),
                "next/dist/client/components/not-found-error",
              ],
              metadata: {
                icon: [
                  async (e) =>
                    (await Promise.resolve().then(s.bind(s, 807))).default(e),
                ],
                apple: [],
                openGraph: [],
                twitter: [],
          ...
          n = ["/root/club_ia_imsp_frontend/src/app/forgot-password/page.tsx"],
          u = "/forgot-password/page",
      ...
      4857: (e, t, s) => {
        Promise.resolve().then(s.t.bind(s, 92, 23)),
          Promise.resolve().then(s.t.bind(s, 7800, 23)),
          Promise.resolve().then(s.t.bind(s, 4830, 23)),
          Promise.resolve().then(s.t.bind(s, 8341, 23)),
          Promise.resolve().then(s.t.bind(s, 4114, 23)),
          Promise.resolve().then(s.t.bind(s, 4152, 23));
      },
      4216: (e, t, s) => {
        Promise.resolve().then(s.bind(s, 4026));
      },
      2165: (e, t, s) => {
        Promise.resolve().then(s.bind(s, 5375));
      },
      2776: (e, t, s) => {
        "use strict";
        s.d(t, { _: () => n, Q: () => u });
        ...
        let n = () => {
          ...
          let [t, s] = (0, a.useState)(""),
            ...
            c = async (s) => {
              s.preventDefault();
              try {
                let s = await d.Z.post(
                  "https://club-ia-imsp-backend.onrender.com/forgot-password",
                  { email: t },
                );
                s.data.sucess &&
                  (C.Am.success(s.data.message), e.push("/reset-password"));
              } catch (e) {
                console.log(e), C.Am.error(e.response.data.message);
              }
            };
          return r.jsx("div", {
              ...
              children: (0, r.jsxs)("div", {
                ...
                children: [
                  r.jsx("div", {
                    ...
                    children: (0, r.jsxs)("div", {
                      className: "px-26 py-17.5 text-center",
                      children: [
                        (0, r.jsxs)(l.default, {
                      ...
                      children: [
                        ...
                        (0, r.jsxs)("form", {
                          ...
                          children: [
                            ...
                            r.jsx("div", {
                              className: "mb-6",
                              children: r.jsx("div", { className: "relative" }),
                            }),
                            r.jsx("div", {
                              className: "mb-5",
                              children: r.jsx("input", {
                                type: "submit",
                                value:
                                  "Recevoir le lien de r\xe9initialisation",
                                className:
        ...
        function d({ children: e }) {
          ...
          return r.jsx("html", {
            ...
            children: (0, r.jsxs)("body", {
              ...
              children: [
                r.jsx("div", {
                  children: r.jsx(o.Ix, { position: "top-right" }),
                }),
                r.jsx("div", {
                  className: "dark:bg-boxdark-2 dark:text-bodydark",
                  children: r.jsx(i._, { children: d ? r.jsx(l, {}) : e }),
                }),
              ],
            }),
          });
      ...
      6908: (e, t, s) => {
        ...
        let r = (0, s(497).createProxy)(
          String.raw`/root/club_ia_imsp_frontend/src/app/forgot-password/page.tsx#default`,
        );
      },
      9863: (e, t, s) => {
        "use strict";
        ...
        let a = (e) => [
          {
            type: "image/x-icon",
            sizes: "16x16",
            url: (0, r.fillMetadataSegment)(".", e.params, "favicon.ico") + "",
          },
        ];
      },
      5125: () => {},
  ...
  t.C(e);
  var s = (e) => t((t.s = e)),
    r = t.X(0, [639, 610, 366, 700], () => s(6495));
  module.exports = r;
})();
