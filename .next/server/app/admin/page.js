(() => {
    ...
    (e.modules = {
      ...
      7950: (e, t, r) => {
        ...
        let o = [
              ...
              children: [
                "admin",
                {
                  children: [
                    ...
                    {
                      page: [
                        () => Promise.resolve().then(r.bind(r, 8043)),
                        "/root/club_ia_imsp_frontend/src/app/admin/page.tsx",
                      ],
                    },
                  ],
                },
          ...
          x = ["/root/club_ia_imsp_frontend/src/app/admin/page.tsx"],
          c = "/admin/page",
      ...
      1785: (e, t, r) => {
        Promise.resolve().then(r.bind(r, 8876));
      },
      8876: (e, t, r) => {
        "use strict";
        ...
        let a = ({
          ...
          (0, s.jsxs)("div", {
            className:
              "rounded-sm border border-stroke bg-white px-7.5 py-6 shadow-default dark:border-strokedark dark:bg-boxdark",
            children: [
              s.jsx("div", {
                className:
              ...
              (0, s.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, s.jsxs)("span", {
                    className: `flex items-center gap-1 text-sm font-medium ${a && "text-meta-3"} ${l && "text-meta-5"} `,
                    children: [
                      r,
                      a &&
                        s.jsx("svg", {
        ...
        var l = r(7120),
          ...
          n = r(5324);
        let o = () => {
            let { articles: e } = (0, i.Q)(),
              t = (0, n.useRouter)(),
              { setData: r, setIsAllowed: a } = (0, i.Q)(),
              l = async (e) => {
                try {
                  await d.Z.delete(`http://localhost:4000/articles/${e}`, {
                    withCredentials: !0,
                  });
                } catch (e) {}
              },
              o = async (e) => {
                try {
                  let s = await d.Z.get(
                    `http://localhost:4000/articles/by/${e}`,
                    { withCredentials: !0 },
                  );
                  r(s.data.data), a(!0), t.push("/forms/form-layout");
                } catch (e) {}
              };
            return s.jsx("div", {
              className:
          ...
          x = () => {
            let { projects: e, setData: t, setIsAllowed: r } = (0, i.Q)(),
              a = (0, n.useRouter)(),
              l = async (e) => {
                try {
                  await d.Z.delete(`http://localhost:4000/articles/${e}`, {
              ...
              o = async (e) => {
                try {
                  ...
                  t(s.data.data), r(!0), a.push("/forms/form-layout");
                } catch (e) {}
              };
            return s.jsx("div", {
              className:
            ...
            return (0, s.jsxs)(s.Fragment, {
              children: [
                (0, s.jsxs)("div", {
                  ...
                  children: [
                    s.jsx(a, {
                      ...
                      total: null !== t ? t.toString() : "Chargement...",
                      rate: "",
                    ...
                    s.jsx(a, {
                      ...
                      total: null !== r ? r.toString() : "Chargement...",
                      rate: "",
                      children: (0, s.jsxs)("svg", {
                        className: "fill-primary dark:fill-white",
                        width: "20",
                    ...
                    s.jsx(a, {
                      ...
                      total: null !== d ? d.toString() : "Chargement...",
                      rate: "",
                      children: (0, s.jsxs)("svg", {
                        className: "fill-primary dark:fill-white",
                        width: "22",
                    ...
                    s.jsx(a, {
                      ...
                      total: null !== e ? e?.toString() : "Chargement...",
                      rate: "",
                      children: (0, s.jsxs)("svg", {
                        className: "fill-primary dark:fill-white",
                        width: "22",
                ...
                (0, s.jsxs)("div", {
                  className: "mt-4",
                  children: [
                    s.jsx("div", { children: s.jsx(l.default, {}) }),
                    s.jsx("div", { className: "py-8", children: s.jsx(o, {}) }),
                    s.jsx("div", { children: s.jsx(x, {}) }),
                  ],
                }),
                s.jsx("div", {
                  className:
        ...
        function p() {
          ...
          return s.jsx(s.Fragment, {
            children: s.jsx(h.default, { children: s.jsx(c, {}) }),
          });
        }
      },
      7120: (e, t, r) => {
        ...
        var s = r(7953),
          ...
          i = r(7201);
        let d = () => {
          let { allEditor: e, role: t } = (0, a.Q)();
          if ((i.Z.get("Authorization"), t && "admin" !== t))
            return s.jsx("p", {});
          let r = async (e) => {
            try {
              await l.Z.delete(
      ...
      8043: (e, t, r) => {
        ...
        let s = (0, r(497).createProxy)(
          String.raw`/root/club_ia_imsp_frontend/src/app/admin/page.tsx#default`,
        );
      },
    });
  ...
  t.C(e);
  var r = (e) => t((t.s = e)),
    s = t.X(0, [639, 610, 366, 700, 522], () => r(7950));
  module.exports = s;
})();
