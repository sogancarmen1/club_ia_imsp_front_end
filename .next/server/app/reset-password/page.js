(() => {
    ...
    (e.modules = {
      ...
      8269: (e, t, s) => {
        ...
        let C = [
              ...
              children: [
                "reset-password",
                {
                  children: [
                    ...
                    {
                      page: [
                        () => Promise.resolve().then(s.bind(s, 8381)),
                        "/root/club_ia_imsp_frontend/src/app/reset-password/page.tsx",
                      ],
                    },
                  ],
                },
          ...
          n = ["/root/club_ia_imsp_frontend/src/app/reset-password/page.tsx"],
      ...
      7983: (e, t, s) => {
        Promise.resolve().then(s.bind(s, 58));
      },
      2776: (e, t, s) => {
        "use strict";
        s.d(t, { _: () => n, Q: () => c });
        ...
        function o({ children: e }) {
          ...
          return r.jsx("html", {
            ...
            children: (0, r.jsxs)("body", {
              ...
              children: [
                r.jsx("div", {
                  children: r.jsx(d.Ix, { position: "top-right" }),
                }),
                r.jsx("div", {
                  className: "dark:bg-boxdark-2 dark:text-bodydark",
                  children: r.jsx(i._, { children: o ? r.jsx(l, {}) : e }),
                }),
              ],
            }),
          });
      ...
      58: (e, t, s) => {
        ...
        let n = () => {
          let e = (0, d.useRouter)(),
            t = (0, d.useSearchParams)().get("token"),
            [s, n] = (0, a.useState)(""),
            [c, u] = (0, a.useState)(""),
            [p, h] = (0, a.useState)("");
          (0, a.useEffect)(() => {
            t || e.push("/auth/signin");
          }, [t]);
          let x = async (r) => {
            if ((r.preventDefault(), s !== c)) {
              C.Am.success("Passwords don't match!");
              return;
            }
            try {
              let r = await o.Z.put(
              ...
              r.data.sucess &&
                (C.Am.success(r.data.message), e.push("/auth/signin"));
            } catch (e) {
              C.Am.error(e.response.data.message);
            }
          };
          return r.jsx("div", {
      ...
      8381: (e, t, s) => {
        ...
        s.r(t), s.d(t, { default: () => r });
        let r = (0, s(497).createProxy)(
          String.raw`/root/club_ia_imsp_frontend/src/app/reset-password/page.tsx#default`,
        );
      },
      807: (e, t, s) => {
        "use strict";
  ...
  t.C(e);
  var s = (e) => t((t.s = e)),
    r = t.X(0, [639, 610, 366, 700], () => s(8269));
  module.exports = r;
})();
