(exports.id = 522),
  ...
  (exports.modules = {
    4857: (e, t, l) => {
      Promise.resolve().then(l.t.bind(l, 92, 23)),
        Promise.resolve().then(l.t.bind(l, 7800, 23)),
        Promise.resolve().then(l.t.bind(l, 4830, 23)),
        Promise.resolve().then(l.t.bind(l, 8341, 23)),
        Promise.resolve().then(l.t.bind(l, 4114, 23)),
        Promise.resolve().then(l.t.bind(l, 4152, 23));
    },
    2165: (e, t, l) => {
      Promise.resolve().then(l.bind(l, 5375));
    },
    2776: (e, t, l) => {
      "use strict";
      l.d(t, { _: () => c, Q: () => h });
      ...
      let n = () => {
        ...
        c = ({ children: e }) => {
          let [t, l] = (0, s.useState)(null),
            [i, d] = (0, s.useState)(null),
            [c, h] = (0, s.useState)(null),
            [u, x] = (0, s.useState)(null),
            ...
            [v, k] = (0, s.useState)(!1),
            [y, N] = (0, s.useState)(""),
            [H, L] = (0, s.useState)(null),
            [Z, M] = (0, s.useState)(null);
          return (
            (0, s.useEffect)(() => {
              let e = n();
              e && (L(e), N(e.role));
      ...
      function n({ children: e }) {
        ...
        return a.jsx("html", {
          ...
          children: (0, a.jsxs)("body", {
            ...
            children: [
              a.jsx("div", {
                children: a.jsx(d.Ix, { position: "top-right" }),
              }),
              a.jsx("div", {
                className: "dark:bg-boxdark-2 dark:text-bodydark",
                children: a.jsx(i._, { children: n ? a.jsx(r, {}) : e }),
              }),
            ],
          }),
        });
    ...
    953: (e, t, l) => {
          ...
          children: a.jsx("ul", {
            ...
            children: e.map((e, l) =>
              a.jsx(
                "li",
                {
                  children: a.jsx(i.default, {
                    href: e.route,
                    className: `group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${t === e.route ? "text-white" : ""}`,
                    children: e.label,
                  }),
                },
                l,
      ...
      var o = l(2776);
      let c = ({ item: e, pageName: t, setPageName: l }) => {
          let { setIsAllowed: s } = (0, o.Q)(),
            d = (0, r.usePathname)(),
            c = (e) =>
              e.route === d || (!!e.children && e.children.some((e) => c(e))),
            h = c(e);
          return a.jsx(a.Fragment, {
            children: (0, a.jsxs)("li", {
              children: [
                (0, a.jsxs)(i.default, {
                  href: e.route,
                  onClick: () =>
                    l(t !== e.label.toLowerCase() ? e.label.toLowerCase() : ""),
                  className: `${h ? "bg-graydark dark:bg-meta-4" : ""} group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4`,
                  children: [
                    e.icon,
                    e.label,
                    e.children &&
                      a.jsx("svg", {
                        className: `absolute right-4 top-1/2 -translate-y-1/2 fill-current ${t === e.label.toLowerCase() && "rotate-180"}`,
                        width: "20",
                        height: "20",
                        viewBox: "0 0 20 20",
                        fill: "none",
                ...
                e.children &&
                  a.jsx("div", {
                    className: `translate transform overflow-hidden ${t !== e.label.toLowerCase() && "hidden"}`,
                    children: a.jsx(n, { item: e.children }),
                  }),
              ],
            }),
          });
        },
        h = ({ children: e, exceptionRef: t, onClick: l, className: r }) => {
          ...
          return (
              ...
              let e = (e) => {
                (t
                  ? (i.current && i.current.contains(e.target)) ||
                    (t.current && t.current === e.target) ||
                    (t.current && t.current.contains(e.target))
                  : i.current && i.current.contains(e.target)) || l();
              };
              return (
            ...
            a.jsx("div", { ref: i, className: `${r || ""}`, children: e })
          );
        },
        u = function (e, t) {
          let [l, a] = (0, s.useState)(() => {});
          return [l, a];
        },
        x = [
          {
        ...
        m = ({ sidebarOpen: e, setSidebarOpen: t }) => {
          (0, r.usePathname)();
          let [l, n] = u("selectedMenu", "dashboard"),
            { isAllowed: m, setIsAllowed: f, role: p } = (0, o.Q)(),
            [C, g] = (0, s.useState)(x);
          return (
            (0, s.useEffect)(() => {
              m &&
                g((e) => {
                  ...
                  return (
                    t.forEach((e) => {
                      e.menuItems[1].children?.some(
                        (e) => "Mise \xe0 jour article/projet" === e.label,
                      ) ||
                        e.menuItems[1].children?.push({
            ...
            a.jsx(h, {
              ...
              children: (0, a.jsxs)("aside", {
                className: `fixed left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${e ? "translate-x-0" : "-translate-x-full"}`,
                children: [
                  (0, a.jsxs)("div", {
                    className:
                            ...
                            children: [
                              ...
                              a.jsx("ul", {
                                ...
                                children: e.menuItems.map((e, t) =>
                                  a.jsx(
                                    c,
                                    { item: e, pageName: l, setPageName: n },
                                    t,
                                  ),
                                ),
                              }),
          ...
          (0, s.useEffect)(() => {
            (async () => {
              try {
                if (n) {
                  let e = await f.Z.get(
                    `https://club-ia-imsp-backend.onrender.com/${l._id}`,
                    { withCredentials: !0 },
                  );
                  u(e.data);
                }
                  ...
                  (0, a.jsxs)("span", {
                    ...
                    children: [
                      a.jsx("span", {
                        ...
                        children: c?.data.email,
                      }),
                      a.jsx("span", {
                        className: "block text-xs",
                        children: c?.data.role,
                      }),
                    ],
                  }),
                  a.jsx("span", {
      ...
      function g({ children: e }) {
        ...
        return a.jsx(a.Fragment, {
          children: (0, a.jsxs)("div", {
            className: "flex",
            children: [
              a.jsx(m, { sidebarOpen: t, setSidebarOpen: l }),
              (0, a.jsxs)("div", {
                className: "relative flex flex-1 flex-col lg:ml-72.5",
                children: [
                  a.jsx(C, { sidebarOpen: t, setSidebarOpen: l }),
                  a.jsx("main", {
                    children: a.jsx("div", {
