...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  //         // Filtrer les éléments de menuItems pour supprimer "Ajouter un article/projet"
  //         const updatedMenuItems = group.menuItems.filter(
  //           (menuItem) => menuItem.label !== "Ajouter un éditeur",
  //         );
  //         return {
  //           ...group,
